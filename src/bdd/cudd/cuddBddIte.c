...
#ifndef lint
static char rcsid[] DD_UNUSED = "$Id: cuddBddIte.c,v 1.1.1.1 2005/04/18 17:40:17 mchu Exp $";
#endif
  ...
  DdNode * h)
{
    ...
    /* Cache lookup. */
    r = cuddConstantLookup(dd, Cudd_bddIteConstant, f, g, h);
    if (r != NULL) {
	...
	cuddCacheInsert(dd, Cudd_bddIteConstant, f, g, h, DD_NON_CONSTANT);
	return(DD_NON_CONSTANT);
    }
    ...
    cuddCacheInsert(dd, Cudd_bddIteConstant, f, g, h, t);
  ...
  DdNode * h)
{
    ...
    /* Check cache. */
    r = cuddCacheLookup(dd, Cudd_bddIte, f, g, h);
    if (r != NULL) {
    ...
    cuddCacheInsert(dd,Cudd_bddIte,f,g,h,r);
    return(Cudd_NotCond(r,comple));
