/**CHeaderFile*****************************************************************
  ...
  Revision    [$Id: cudd.h,v 1.1.1.1 2005/04/18 17:40:17 mchu Exp $]
...
#define CUDD_VERSION "2.2.0"

/* 02/14/03 REK This should all be handled by configure (config.h) now. */
...
#define CUDD_OUT_OF_MEM		-1L
/* The sizes of the subtables and the cache must be powers of two. */
#define CUDD_UNIQUE_SLOTS	512	/* initial size of subtables */
...
EXTERN void Cudd_SetMaxCache ARGS((DdManager *dd, unsigned int mc));
...
EXTERN int Cudd_AddHook ARGS((DdManager *dd, int (*f)(DdManager *, void *), Cudd_HookType where));
EXTERN int Cudd_RemoveHook ARGS((DdManager *dd, int (*f)(DdManager *, void *), Cudd_HookType where));
EXTERN int Cudd_IsInHook ARGS((DdManager * dd, int (*f)(DdManager *, void *), Cudd_HookType where));
EXTERN int Cudd_StdPreReordHook ARGS((DdManager *dd, void *data));
EXTERN int Cudd_StdPostReordHook ARGS((DdManager *dd, void *data));
