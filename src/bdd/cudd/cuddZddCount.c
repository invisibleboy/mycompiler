...
#ifndef lint
static char rcsid[] DD_UNUSED = "$Id: cuddZddCount.c,v 1.1.1.1 2005/04/18 17:40:17 mchu Exp $";
#endif
  ...
  DdNode * empty)
{
    ...
    res = cuddZddCountStep(Cudd_E(P), table, base, empty) +
	cuddZddCountStep(Cudd_T(P), table, base, empty);
  ...
  DdNode * empty)
{
    ...
    res = cuddZddCountDoubleStep(Cudd_E(P), table, base, empty) +
	cuddZddCountDoubleStep(Cudd_T(P), table, base, empty);
