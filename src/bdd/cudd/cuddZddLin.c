...
#ifndef lint
static char rcsid[] DD_UNUSED = "$Id: cuddZddLin.c,v 1.1.1.1 2005/04/18 17:40:17 mchu Exp $";
#endif
...
zddSwapOutOfMem:
    (void) fprintf(stderr, "Error: cuddZddSwapInPlace() out of memory\n");
