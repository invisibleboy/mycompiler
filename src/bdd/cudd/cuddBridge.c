...
#ifndef lint
static char rcsid[] DD_UNUSED = "$Id: cuddBridge.c,v 1.1.1.1 2005/04/18 17:40:17 mchu Exp $";
#endif
  ...
  DdNode * u)
{
    ...
    /* Check cache. */
    res = cuddCacheLookup(dd,addBddDoInterval,f,l,u);
    if (res != NULL) return(res);
    ...
    /* Store result. */
    cuddCacheInsert(dd,addBddDoInterval,f,l,u,res);
