...
#ifndef lint
static char rcsid[] DD_UNUSED = "$Id: cuddGenCof.c,v 1.1.1.1 2005/04/18 17:40:17 mchu Exp $";
#endif
  ...
  DdNode * c /* constraint (care set) */)
{
    ...
    ** For the result building step we argue as follows. The result for a
    ** node and a given constrain depends on the BDD in which the node
