...
#ifndef lint
static char rcsid[] DD_UNUSED = "$Id: cuddZddSetop.c,v 1.1.1.1 2005/04/18 17:40:17 mchu Exp $";
#endif
  ...
  DdNode * h)
{
    ...
    /* Check cache. */
    r = cuddCacheLookupZdd(dd,Cudd_zddIte,f,g,h);
    if (r != NULL) {
	return(r);
    }
    ...
    cuddCacheInsert(dd,Cudd_zddIte,f,g,h,r);
