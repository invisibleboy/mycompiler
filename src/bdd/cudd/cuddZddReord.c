...
#ifndef lint
static char rcsid[] DD_UNUSED = "$Id: cuddZddReord.c,v 1.1.1.1 2005/04/18 17:40:17 mchu Exp $";
#endif
  ...
  int minsize /* bound below which no reordering occurs */)
{
    ...
    */
	...
	break;
    default:
	(void) fprintf(stderr,"Unsupported ZDD reordering method\n");
	return(0);
    }
...
#pragma pointer_size restore
    ...
    DdNode	*newf1 = NULL, *newf0, *g, *next, *last, *previous;
