...
util_print_cpu_stats(FILE *fp)
{
    ...
    vm_text = (int) (((int) (&etext)) / 1024.0 + 0.5);
    vm_init_data = (int) (((int) (&edata) - (int) (&etext)) / 1024.0 + 0.5);
    vm_uninit_data = (int) (((int) (&end) - (int) (&edata)) / 1024.0 + 0.5);
    vm_sbrk_data = (int) (((int) (util_ptrint) sbrk(0) - (int) (&end)) / 1024.0 + 0.5);
